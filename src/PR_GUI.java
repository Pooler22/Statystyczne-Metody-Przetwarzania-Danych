    ...
    private void TrainButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TrainButtonActionPerformed
        ...
        switch (selectedItem) {
            case "Nearest neighbor (NN)":
                Cl = new NNClassifier(data.FNew, data.ClassLabels);
                break;
            case "Nearest Mean (NM)":
                Cl = new NMClassifier(data.FNew, data.ClassLabels);
                break;
            case "k-Nearest Neighbor (k-NN)":
                Cl = new KNNClassifier(data.FNew, data.ClassLabels, Integer.parseInt(jComboBox1.getSelectedItem().toString()));
                break;
            case "k-Nearest Mean (k-NM)":
                Cl = new KNMClassifier(data.FNew, data.ClassLabels, data.SampleCount, Integer.parseInt(jComboBox1.getSelectedItem().toString()));
                break;
        }
