...
public class PR_GUI extends javax.swing.JFrame {
    ...
    private void FeatureSelectionRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {
        FisherCriterionComboBox.setEnabled(true);
        FeatureExtarctionRadioButton.setSelected(false);
        PCALDAComboBox.setEnabled(false);
    }

    private void FeatureExtarctionRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {
        FisherCriterionComboBox.setEnabled(false);
        FeatureSelectionRadioButton.setSelected(false);
        PCALDAComboBox.setEnabled(true);
    }

    private void ReadDatasetButtonActionPerformed(java.awt.event.ActionEvent evt) {
        // reads in a text file; contents is placed into a variable of String type
        InData = readDataSet();
    }

    private void ParseDatasetButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void DeriveFeatureSpaceButtonActionPerformed(java.awt.event.ActionEvent evt) {
